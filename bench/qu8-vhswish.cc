  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  BENCHMARK_CAPTURE(qu8_vhswish, neon_x8,
                    xnn_qu8_vhswish_ukernel__neon_x8,
                    xnn_init_qu8_hswish_neon_params,
                    benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(qu8_vhswish, neon_x16,
                    xnn_qu8_vhswish_ukernel__neon_x16,
                    xnn_init_qu8_hswish_neon_params,
                    benchmark::utils::CheckNEON)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(qu8_vhswish, neon_x32,
...
BENCHMARK_CAPTURE(qu8_vhswish, scalar_x4,
  ...
  BENCHMARK_CAPTURE(qu8_vhswish, sse41_x8,
                    xnn_qu8_vhswish_ukernel__sse41_x8,
                    xnn_init_qu8_hswish_sse2_params,
                    benchmark::utils::CheckSSE41)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(qu8_vhswish, sse41_x16,
                    xnn_qu8_vhswish_ukernel__sse41_x16,
                    xnn_init_qu8_hswish_sse2_params,
                    benchmark::utils::CheckSSE41)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(qu8_vhswish, sse41_x32,
                    xnn_qu8_vhswish_ukernel__sse41_x32,
                    xnn_init_qu8_hswish_sse2_params,
                    benchmark::utils::CheckSSE41)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();

  BENCHMARK_CAPTURE(qu8_vhswish, ssse3_x16,
                    xnn_qu8_vhswish_ukernel__ssse3_x16,
                    xnn_init_qu8_hswish_sse2_params,
                    benchmark::utils::CheckSSSE3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(qu8_vhswish, ssse3_x32,
                    xnn_qu8_vhswish_ukernel__ssse3_x32,
                    xnn_init_qu8_hswish_sse2_params,
                    benchmark::utils::CheckSSSE3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();

  BENCHMARK_CAPTURE(qu8_vhswish, sse2_x16,
                    xnn_qu8_vhswish_ukernel__sse2_x16,
                    xnn_init_qu8_hswish_sse2_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(qu8_vhswish, sse2_x32,
                    xnn_qu8_vhswish_ukernel__sse2_x32,
                    xnn_init_qu8_hswish_sse2_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<uint8_t, uint8_t>)
    ->UseRealTime();
