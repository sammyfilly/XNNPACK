...
parser = argparse.ArgumentParser(description='VLShift microkernel test generator')
...
def generate_test_cases(ukernel, batch_tile, isa):
  """Generates all tests cases for a VLShift micro-kernel.
  ...
  return xngen.preprocess(VLSHIFT_TEST_TEMPLATE, {
