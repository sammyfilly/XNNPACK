...
ExecutionPlan FP16SparseMobileNetV2(float sparsity, pthreadpool_t threadpool) {
  ...
  std::generate(w69.begin(), w69.end() - size_t(sparsity * w69.size()), std::ref(f16rng));
  std::shuffle(w69.begin(), w69.end(), rng);
  std::generate(w70.begin(), w70.end(), std::ref(f16rng));
  std::fill(w71.begin(), w71.end(), 0.0f);
  std::generate(w71.begin(), w71.end() - size_t(sparsity * w71.size()), std::ref(f16rng));
  ...
  std::generate(w75.begin(), w75.end() - size_t(sparsity * w75.size()), std::ref(f16rng));
  std::shuffle(w75.begin(), w75.end(), rng);
  std::generate(w76.begin(), w76.end(), std::ref(f16rng));
  std::fill(w77.begin(), w77.end(), 0.0f);
  std::generate(w77.begin(), w77.end() - size_t(sparsity * w77.size()), std::ref(f16rng));
  ...
  std::generate(w81.begin(), w81.end() - size_t(sparsity * w81.size()), std::ref(f16rng));
  std::shuffle(w81.begin(), w81.end(), rng);
  std::generate(w82.begin(), w82.end(), std::ref(f16rng));
  std::fill(w83.begin(), w83.end(), 0.0f);
  std::generate(w83.begin(), w83.end() - size_t(sparsity * w83.size()), std::ref(f16rng));
  ...
  std::generate(w87.begin(), w87.end() - size_t(sparsity * w87.size()), std::ref(f16rng));
  std::shuffle(w87.begin(), w87.end(), rng);
  std::generate(w88.begin(), w88.end(), std::ref(f16rng));
  std::fill(w89.begin(), w89.end(), 0.0f);
  std::generate(w89.begin(), w89.end() - size_t(sparsity * w89.size()), std::ref(f16rng));
  ...
  std::generate(w93.begin(), w93.end() - size_t(sparsity * w93.size()), std::ref(f16rng));
  std::shuffle(w93.begin(), w93.end(), rng);
  std::generate(w94.begin(), w94.end(), std::ref(f16rng));
  std::fill(w95.begin(), w95.end(), 0.0f);
  std::generate(w95.begin(), w95.end() - size_t(sparsity * w95.size()), std::ref(f16rng));
  ...
  std::generate(w99.begin(), w99.end() - size_t(sparsity * w99.size()), std::ref(f16rng));
  std::shuffle(w99.begin(), w99.end(), rng);
  std::generate(w100.begin(), w100.end(), std::ref(f16rng));
  std::fill(w101.begin(), w101.end(), 0.0f);
  std::generate(w101.begin(), w101.end() - size_t(sparsity * w101.size()), std::ref(f16rng));
  ...
  std::generate(w105.begin(), w105.end() - size_t(sparsity * w105.size()), std::ref(f16rng));
  std::shuffle(w105.begin(), w105.end(), rng);
  std::generate(w106.begin(), w106.end(), std::ref(f16rng));
  std::fill(w107.begin(), w107.end(), 0.0f);
  std::generate(w107.begin(), w107.end() - size_t(sparsity * w107.size()), std::ref(f16rng));
  ...
  std::generate(w111.begin(), w111.end() - size_t(sparsity * w111.size()), std::ref(f16rng));
  std::shuffle(w111.begin(), w111.end(), rng);
  std::generate(w112.begin(), w112.end(), std::ref(f16rng));
  std::fill(w113.begin(), w113.end(), 0.0f);
  std::generate(w113.begin(), w113.end() - size_t(sparsity * w113.size()), std::ref(f16rng));
  ...
  std::generate(w117.begin(), w117.end() - size_t(sparsity * w117.size()), std::ref(f16rng));
  std::shuffle(w117.begin(), w117.end(), rng);
  std::generate(w118.begin(), w118.end(), std::ref(f16rng));
  std::fill(w119.begin(), w119.end(), 0.0f);
  std::generate(w119.begin(), w119.end() - size_t(sparsity * w119.size()), std::ref(f16rng));
  ...
  std::generate(w123.begin(), w123.end() - size_t(sparsity * w123.size()), std::ref(f16rng));
  std::shuffle(w123.begin(), w123.end(), rng);
  std::generate(w124.begin(), w124.end(), std::ref(f16rng));
  std::fill(w125.begin(), w125.end(), 0.0f);
  std::generate(w125.begin(), w125.end() - size_t(sparsity * w125.size()), std::ref(f16rng));
  ...
  std::generate(w129.begin(), w129.end() - size_t(sparsity * w129.size()), std::ref(f16rng));
  std::shuffle(w129.begin(), w129.end(), rng);
  std::generate(w130.begin(), w130.end(), std::ref(f16rng));
  std::fill(w131.begin(), w131.end(), 0.0f);
  std::generate(w131.begin(), w131.end() - size_t(sparsity * w131.size()), std::ref(f16rng));
  ...
  std::generate(w135.begin(), w135.end() - size_t(sparsity * w135.size()), std::ref(f16rng));
  std::shuffle(w135.begin(), w135.end(), rng);
  std::generate(w136.begin(), w136.end(), std::ref(f16rng));
  std::fill(w137.begin(), w137.end(), 0.0f);
  std::generate(w137.begin(), w137.end() - size_t(sparsity * w137.size()), std::ref(f16rng));
  ...
  std::generate(w141.begin(), w141.end() - size_t(sparsity * w141.size()), std::ref(f16rng));
  std::shuffle(w141.begin(), w141.end(), rng);
  std::generate(w142.begin(), w142.end(), std::ref(f16rng));
  std::fill(w143.begin(), w143.end(), 0.0f);
  std::generate(w143.begin(), w143.end() - size_t(sparsity * w143.size()), std::ref(f16rng));
  ...
  std::generate(w147.begin(), w147.end() - size_t(sparsity * w147.size()), std::ref(f16rng));
  std::shuffle(w147.begin(), w147.end(), rng);
  std::generate(w148.begin(), w148.end(), std::ref(f16rng));
  std::fill(w149.begin(), w149.end(), 0.0f);
  std::generate(w149.begin(), w149.end() - size_t(sparsity * w149.size()), std::ref(f16rng));
  ...
  std::generate(w153.begin(), w153.end() - size_t(sparsity * w153.size()), std::ref(f16rng));
  std::shuffle(w153.begin(), w153.end(), rng);
  std::generate(w154.begin(), w154.end(), std::ref(f16rng));
  std::fill(w155.begin(), w155.end(), 0.0f);
  std::generate(w155.begin(), w155.end() - size_t(sparsity * w155.size()), std::ref(f16rng));
  ...
  std::generate(w159.begin(), w159.end() - size_t(sparsity * w159.size()), std::ref(f16rng));
  std::shuffle(w159.begin(), w159.end(), rng);
  std::generate(w160.begin(), w160.end(), std::ref(f16rng));
  std::fill(w161.begin(), w161.end(), 0.0f);
  std::generate(w161.begin(), w161.end() - size_t(sparsity * w161.size()), std::ref(f16rng));
