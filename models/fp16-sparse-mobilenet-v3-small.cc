...
ExecutionPlan FP16SparseMobileNetV3Small(float sparsity, pthreadpool_t threadpool) {
  ...
  std::generate(w114.begin(), w114.end() - size_t(sparsity * w114.size()), std::ref(f16rng));
  std::shuffle(w114.begin(), w114.end(), rng);
  std::generate(w115.begin(), w115.end(), std::ref(f16rng));
  std::fill(w116.begin(), w116.end(), 0.0f);
  std::generate(w116.begin(), w116.end() - size_t(sparsity * w116.size()), std::ref(f16rng));
  ...
  std::generate(w122.begin(), w122.end() - size_t(sparsity * w122.size()), std::ref(f16rng));
  ...
  std::generate(w128.begin(), w128.end() - size_t(sparsity * w128.size()), std::ref(f16rng));
  ...
  std::generate(w170.begin(), w170.end() - size_t(sparsity * w170.size()), std::ref(f16rng));
  ...
  std::generate(w176.begin(), w176.end() - size_t(sparsity * w176.size()), std::ref(f16rng));
  ...
  std::generate(w182.begin(), w182.end() - size_t(sparsity * w182.size()), std::ref(f16rng));
  ...
  std::generate(w188.begin(), w188.end() - size_t(sparsity * w188.size()), std::ref(f16rng));
  ...
  std::generate(w198.begin(), w198.end() - size_t(sparsity * w198.size()), std::ref(f16rng));
